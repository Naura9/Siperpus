...
$sql = "SELECT * FROM peminjaman p INNER JOIN detail_pinjam dp 
        ON p.id_pinjam=dp.id_pinjam INNER JOIN buku b ON
        b.id_buku = dp.id_buku WHERE p.id_pinjam='$id_pinjam'";  
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="text-right" colspan="2">
                            <a href="index.php" class="btn btn-succes"><i class="fas fa-angle-double-left"></i>Kembali</a>
